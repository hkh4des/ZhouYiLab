...
export const get_crash_logs = (fn : (value : string[]) => void) => {
	...
	if (crash_data != null && crash_data.length > 0) {
		...
		Promise.all(reportLogs)
			...
			.catch((err) => {
				__f__('log','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:504','Errorlogs:', err);
			});
	}
}
...
export const calibration = (eventName : string, options : any | null) : ReportErrorCode | null => {
	...
	if (eventName == '') {
		// __f__('error','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:516',`uni.report Missing [eventName] parameter`)
		return 61003
	}
	if (typeof eventName != 'string') {
		// __f__('error','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:520',
		// 	`uni.report [eventName] Parameter type error, it can only be of type String`
		// )
		return 61004
	}
	if (eventName.length > 255) {
		// __f__('error','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:526',
	...
	if (typeof options != 'string' && typeof options != 'object') {
		// __f__('error','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:533',
	...
	if (typeof options == 'string' && (options as string).length > 255) {
		// __f__('error','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:540',
	...
	if (eventName == 'title' && typeof options != 'string') {
		// __f__('error','at uni_modules/uni-stat/utssdk/common/utils/pageInfo.uts:547',
