...
export class Stat {
    ...
    if (Report.uniCloudInstance == null) {
      ...
      if (space != null) {
        ...
        if (!Stat.no_space) {
          ...
          __f__('log','at uni_modules/uni-stat/utssdk/common/core/stat.uts:50',"\u001b[31m应用已集成uni统计，但未关联服务空间，请在uniCloud目录右键关联服务空间\u001b[0m")
  ...
  appEvent(name : string, options : any | null = null, fn : ErrorCallback) {
    ...
    // 	// __f__('error','at uni_modules/uni-stat/utssdk/common/core/stat.uts:256','uniStatReport 事件名不存在，请检查！');
