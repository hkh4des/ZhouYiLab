...
export function Log(data : StatDefault, type : Boolean = false) {
	...
	if (type) {
		__f__('log','at uni_modules/uni-stat/utssdk/common/utils/index.uts:87',`=== 统计队列数据上报 :`, logData)
		// __f__('log','at uni_modules/uni-stat/utssdk/common/utils/index.uts:88',logData)
		// __f__('log','at uni_modules/uni-stat/utssdk/common/utils/index.uts:89',`=== 上报结束 ===`)
		return
	}

	if (msg_type != '') {
		__f__('log','at uni_modules/uni-stat/utssdk/common/utils/index.uts:94',`=== 统计数据采集：${msg_type} :`,logData)
		// __f__('log','at uni_modules/uni-stat/utssdk/common/utils/index.uts:95',logData)
		// __f__('log','at uni_modules/uni-stat/utssdk/common/utils/index.uts:96',`=== 采集结束 ===`)
	}
}
