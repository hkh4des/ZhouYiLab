...
export interface Uni {
   ...
   * ```typescript
    uni.openLocation({
      ...
      longitude: 116.39747,
      success: (res) => {
        __f__('log','at uni_modules/uni-openLocation/utssdk/interface.uts:369','res: ', res)
      },
      fail: (err) => {
        __f__('log','at uni_modules/uni-openLocation/utssdk/interface.uts:372','err: ', err)
      },
      complete: (res) => {
        __f__('log','at uni_modules/uni-openLocation/utssdk/interface.uts:375','complete: ', res)
      }
    });
   * ```
   * @tutorial https://doc.dcloud.net.cn/uni-app-x/api/prompt.html#openLocation
