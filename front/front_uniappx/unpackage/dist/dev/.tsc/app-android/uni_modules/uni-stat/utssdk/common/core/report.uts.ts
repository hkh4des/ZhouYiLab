...
export class Report {
  ...
  crashRequest(data : StatDefault, crash_data : string[]) {
    ...
    if (statConfig.debug!) {
      // 待上传消息对列
      // __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:620',`=== 统计待上传队列数据 ===`)
      const statJSON = Map2Json(uniStatData)
      __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:622','=== 统计待上传队列数据 :', statJSON)
      // __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:623',`=== 采集结束 ===`)
    }
  ...
  request(data : StatDefault, type : boolean = false) {
    ...
    if (statConfig.debug!) {
      // 待上传消息对列
      // __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:699',`=== 统计待上传队列数据 ===`)
      const statJSON = Map2Json(uniStatData)
      __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:701','=== 统计待上传队列数据 :', statJSON)
      // __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:702',`=== 采集结束 ===`)
    }
  ...
  sendRequest(options : RequestData, delCrash : boolean = false) {
    ...
    if (Report.uniCloudInstance != null) {
      ...
      uniCloudObj
        ...
        .then(() => {
          if (statConfig.debug!) {
            __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:751',`=== 统计队列数据上报 :`, options)
          }
          ...
          if (delCrash) {
            try {
              ...
              __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:758','=== 应用崩溃日志上传失败 :', JSON.stringify(err))
            }
          }
        ...
        .catch((err : any | null) => {
          __f__('log','at uni_modules/uni-stat/utssdk/common/core/report.uts:765','=== 统计上报错误 :', JSON.stringify(err))
        })
    }
