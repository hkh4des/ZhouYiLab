    ...
    createElementVNode("view", utsMapOf({ class: "uni-common-mt" }), [
      createElementVNode("view", utsMapOf({ class: "uni-list" }), [
        createElementVNode("view", utsMapOf({ class: "uni-list-cell cell-pd" }), [
          createElementVNode("text", utsMapOf({ class: "uni-list-cell-left uni-label" }), " 图片来源 "),
        ...
        createElementVNode("view", utsMapOf({ class: "uni-list-cell cell-pd" }), [
          createElementVNode("text", utsMapOf({ class: "uni-list-cell-left uni-label" }), " 图片质量 "),
          createElementVNode("view", utsMapOf({
            class: "uni-list-cell-right",
        ...
        createElementVNode("view", utsMapOf({ class: "uni-list-cell cell-pd" }), [
          createElementVNode("text", utsMapOf({ class: "uni-list-cell-left uni-label" }), " 数量限制 "),
        ...
        createElementVNode("view", utsMapOf({ class: "uni-list-cell cell-pd" }), [
          createElementVNode("text", utsMapOf({ class: "uni-list-cell-left uni-label" }), " 屏幕方向 "),
          createElementVNode("view", utsMapOf({
            class: "uni-list-cell-right",
        ...
        createElementVNode("view", utsMapOf({ class: "uni-list-cell cell-pd" }), [
          createElementVNode("text", utsMapOf({ class: "uni-list-cell-left uni-label" }), " 相册模式 "),
          createElementVNode("view", utsMapOf({
            class: "uni-list-cell-right",
        ...
        createElementVNode("view", utsMapOf({ class: "uni-list-cell cell-pd" }), [
          createElementVNode("text", utsMapOf({ class: "uni-list-cell-left uni-label" }), " 图像裁剪 "),
          createElementVNode("view", utsMapOf({ class: "uni-list-cell-right" }), [
      ...
      createElementVNode("view", utsMapOf({
        ...
        createElementVNode("view", utsMapOf({
          ...
          createElementVNode("view", utsMapOf({
            ...
            createElementVNode("text", utsMapOf({ class: "click-t" }), toDisplayString(_ctx.imageList.length) + "/" + toDisplayString(_ctx.count), 1 /* TEXT */)
          ], 4 /* STYLE */)
        ], 4 /* STYLE */),
        createElementVNode("view", utsMapOf({
          class: "uni-flex",
...
const GenPagesAPIChooseImageChooseImageStyles = [utsMapOf([["cell-pd", padStyleMapOf(utsMapOf([["paddingTop", 11], ["paddingRight", 15], ["paddingBottom", 11], ["paddingLeft", 15]]))], ["click-t", padStyleMapOf(utsMapOf([["color", "#A9A9A9"]]))], ["list-pd", padStyleMapOf(utsMapOf([["marginTop", 25]]))], ["uni-uploader__input-box", padStyleMapOf(utsMapOf([["marginTop", 5], ["marginRight", 5], ["marginBottom", 5], ["marginLeft", 5], ["width", 104], ["height", 104], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#D9D9D9"], ["borderRightColor", "#D9D9D9"], ["borderBottomColor", "#D9D9D9"], ["borderLeftColor", "#D9D9D9"]]))], ["uni-uploader__input", padStyleMapOf(utsMapOf([["position", "absolute"], ["zIndex", 1], ["top", 0], ["left", 0], ["width", "100%"], ["height", "100%"], ["opacity", 0]]))], ["image-remove", padStyleMapOf(utsMapOf([["transform", "rotate(45deg)"], ["width", 25], ["height", 25], ["position", "absolute"], ["top", 0], ["right", 0], ["borderTopLeftRadius", 13], ["borderTopRightRadius", 13], ["borderBottomRightRadius", 13], ["borderBottomLeftRadius", 13], ["backgroundColor", "rgba(200,200,200,0.8)"]]))], ["item_width", padStyleMapOf(utsMapOf([["width", 130]]))], ["crop-option", padStyleMapOf(utsMapOf([["marginLeft", 11], ["marginRight", 11], ["borderTopLeftRadius", 11], ["borderTopRightRadius", 11], ["borderBottomRightRadius", 11], ["borderBottomLeftRadius", 11], ["backgroundColor", "#eeeeee"], ["transitionProperty", "height,marginBottom"], ["transitionDuration", "200ms"]]))], ["@TRANSITION", utsMapOf([["crop-option", utsMapOf([["property", "height,marginBottom"], ["duration", "200ms"]])]])]])]
