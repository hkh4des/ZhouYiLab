...
const GenPagesTemplateSwiperVerticalVideoSwiperVerticalVideoStyles = [utsMapOf([["page", padStyleMapOf(utsMapOf([["flex", 1]]))], ["swiper", padStyleMapOf(utsMapOf([["width", "100%"], ["height", "100%"]]))], ["swiper-item", padStyleMapOf(utsMapOf([["width", "100%"], ["height", "100%"], ["position", "relative"]]))], ["video-box", padStyleMapOf(utsMapOf([["width", "100%"], ["height", "100%"]]))], ["video-cover", padStyleMapOf(utsMapOf([["width", "100%"], ["height", "100%"], ["position", "absolute"], ["justifyContent", "center"], ["alignItems", "center"], ["alignContent", "center"]]))], ["play-btn", padStyleMapOf(utsMapOf([["width", 40], ["height", 40]]))], ["video-info", padStyleMapOf(utsMapOf([["position", "absolute"], ["bottom", 0], ["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15]]))], ["video-info-text", padStyleMapOf(utsMapOf([["fontSize", 14], ["color", "#FF0000"], ["lineHeight", "20px"]]))], ["debug-info", padStyleMapOf(utsMapOf([["position", "fixed"], ["top", 15], ["width", "100%"], ["backgroundColor", "rgba(255,255,255,0.3)"]]))], ["status-text", padStyleMapOf(utsMapOf([["color", "#FF0000"], ["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15]]))], ["nav-back", padStyleMapOf(utsMapOf([["position", "absolute"], ["top", 35], ["backgroundColor", "rgba(220,220,220,0.8)"], ["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100], ["marginTop", 6], ["marginRight", 6], ["marginBottom", 6], ["marginLeft", 6], ["width", 32], ["height", 32], ["justifyContent", "center"], ["alignItems", "center"], ["zIndex", 10]]))], ["back-img", utsMapOf([[".nav-back ", utsMapOf([["width", 18], ["height", 18]])]])]])]
