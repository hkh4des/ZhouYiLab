  ...
  return createElementVNode("scroll-view", utsMapOf({
    ...
    createElementVNode("view", null, [
      ...
      createElementVNode("view", null, [
        ...
        }), toDisplayString(_ctx.testStyle), 13 /* TEXT, STYLE, PROPS */, ["onClick"])
      ]),
      createElementVNode("view", null, [
        createElementVNode("text", null, "class 动态切换 background"),
        createElementVNode("view", utsMapOf({
          onClick: _ctx.changeBgClass,
          class: normalizeClass(["common", _ctx.testClass])
        }), toDisplayString(_ctx.testClass), 11 /* TEXT, CLASS, PROPS */, ["onClick"])
      ])
    ])
  ], 4 /* STYLE */)
}
const GenPagesCSSBackgroundBackgroundImageStyles = [utsMapOf([["common", padStyleMapOf(utsMapOf([["width", 250], ["height", 250]]))], ["bg-color", padStyleMapOf(utsMapOf([["backgroundImage", "none"], ["backgroundColor", "#0000FF"]]))], ["bg-image", padStyleMapOf(utsMapOf([["backgroundImage", "linear-gradient(to right, red, yellow)"], ["backgroundColor", "rgba(0,0,0,0)"]]))]])]
