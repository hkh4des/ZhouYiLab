  ...
  return createElementVNode("scroll-view", utsMapOf({
    ...
    createElementVNode("view", null, [
      ...
      createElementVNode("view", utsMapOf({ class: "backgroundview" }), [
        createElementVNode("view", utsMapOf({
          id: "zindex-overflow",
          style: normalizeStyle(utsMapOf({"width":"1px","height":"1px","overflow":"visible","z-index":"100"})),
          onClick: () => {_ctx.handleClick('red')}
        }), [
          createElementVNode("view", utsMapOf({
            style: normalizeStyle(utsMapOf({"width":"100px","height":"100px","background-color":"red"}))
          }), null, 4 /* STYLE */)
        ], 12 /* STYLE, PROPS */, ["onClick"]),
        createElementVNode("view", utsMapOf({
          style: normalizeStyle(utsMapOf({"width":"1px","height":"1px","overflow":"visible"}))
        }), [
          createElementVNode("view", utsMapOf({
            style: normalizeStyle(utsMapOf({"width":"100px","height":"100px","background-color":"green"}))
          }), null, 4 /* STYLE */)
        ], 4 /* STYLE */)
      ])
    ])
...
const GenPagesCSSOverflowOverflowVisibleEventStyles = [utsMapOf([["backgroundview", padStyleMapOf(utsMapOf([["width", 300], ["height", 300], ["marginBottom", 20], ["backgroundColor", "#FFFFFF"], ["justifyContent", "center"], ["alignItems", "center"]]))], ["box-visible-border-radius", padStyleMapOf(utsMapOf([["width", 100], ["height", 100], ["borderTopLeftRadius", 20], ["borderTopRightRadius", 20], ["borderBottomRightRadius", 20], ["borderBottomLeftRadius", 20], ["overflow", "visible"], ["backgroundColor", "#008000"]]))], ["hover-class", padStyleMapOf(utsMapOf([["backgroundColor", "#00FFFF"]]))], ["box", padStyleMapOf(utsMapOf([["width", 1], ["height", 1], ["overflow", "visible"]]))]])]
