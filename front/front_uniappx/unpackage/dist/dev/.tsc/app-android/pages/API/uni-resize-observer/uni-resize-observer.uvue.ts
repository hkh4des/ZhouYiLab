...
const GenPagesAPIUniResizeObserverUniResizeObserverStyles = [utsMapOf([["info-item", padStyleMapOf(utsMapOf([["flexDirection", "row"]]))], ["info-text", padStyleMapOf(utsMapOf([["fontSize", 14]]))]])]
