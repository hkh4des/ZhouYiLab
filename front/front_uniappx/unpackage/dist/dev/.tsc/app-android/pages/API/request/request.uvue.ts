  ...
  class GETDataType  implements IUTSSourceMap{
// @ts-expect-error 
override __$getOriginalPosition(): UTSSourceMapPosition { return new UTSSourceMapPosition("GETDataType", "pages/API/request/request.uvue", 99, 9);}
...
const GenPagesAPIRequestRequestStyles = [utsMapOf([["uni-textarea", padStyleMapOf(utsMapOf([["paddingTop", 9], ["paddingRight", 9], ["paddingBottom", 9], ["paddingLeft", 9], ["fontSize", 14]]))]])]
