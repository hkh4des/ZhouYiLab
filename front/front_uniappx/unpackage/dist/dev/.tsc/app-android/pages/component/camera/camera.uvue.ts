...
const _component_radio_group = resolveComponent("radio-group")
  ...
  return createElementVNode("view", utsMapOf({
    ...
    createVNode(_component_camera, utsMapOf({
      style: normalizeStyle(utsMapOf({"width":"100%","height":"300px"})),
      resolution: 'medium',
      ...
      createElementVNode("view", null, [
        ...
        createElementVNode("view", null, [
          createElementVNode("view", utsMapOf({ class: "uni-title" }), [
            createElementVNode("text", utsMapOf({ class: "uni-title-text" }), "设置预览缩放")
          ]),
          createElementVNode("view", utsMapOf({ class: "uni-camera-wrapper" }), [
        ...
        createElementVNode("view", null, [
          createElementVNode("view", utsMapOf({ class: "uni-title" }), [
            createElementVNode("text", utsMapOf({ class: "uni-title-text" }), "拍摄照片示例"),
            createElementVNode("button", utsMapOf({
              type: "default",
            ...
            createVNode(_component_radio_group, utsMapOf({
              ...
              default: withSlotCtx((): any[] => [
                ...
                createVNode(_component_radio, utsMapOf({ value: "low" }), utsMapOf({
                  default: withSlotCtx((): any[] => ["低质量"]),
                  _: 1 /* STABLE */
                })),
                createVNode(_component_radio, utsMapOf({ value: "high" }), utsMapOf({
                  default: withSlotCtx((): any[] => ["高质量"]),
                  _: 1 /* STABLE */
                })),
                createVNode(_component_radio, utsMapOf({ value: "original" }), utsMapOf({
        ...
        createElementVNode("view", null, [
          createElementVNode("view", utsMapOf({ class: "uni-title" }), [
            createElementVNode("text", utsMapOf({ class: "uni-title-text" }), "录制视频示例"),
            createElementVNode("view", utsMapOf({
              style: normalizeStyle(utsMapOf({"flex-direction":"row","margin-top":"8px"}))
            }), [
              createElementVNode("text", utsMapOf({ class: "uni-title-size" }), "录制时长："),
              createElementVNode("input", utsMapOf({
                class: "uni-title-size",
                style: normalizeStyle(utsMapOf({"width":"50px","margin-left":"10px","border":"0.5px solid grey","text-align":"right"})),
                type: "number",
            ...
            createElementVNode("button", utsMapOf({
              type: "default",
              style: normalizeStyle(utsMapOf({"font-family":"monospace","margin-top":"8px"})),
              onClick: _ctx.startRecord,
              disabled: _ctx.startRecordStatus
            }), toDisplayString(_ctx.startRecordStatus ? `${_ctx.remain}秒` : "录制视频"), 13 /* TEXT, STYLE, PROPS */, ["onClick", "disabled"]),
            createElementVNode("button", utsMapOf({
              type: "default",
          ...
          createElementVNode("view", utsMapOf({ class: "uni-camera-wrapper" }), [
            _ctx.videoSrc != ''
              ? createElementVNode("video", utsMapOf({
                  key: 0,
                  class: "uni-camera-test-host-without-flex",
                  style: normalizeStyle(utsMapOf({"width":"300px","height":"300px"})),
                  src: _ctx.videoSrc,
                  controls: true
                }), null, 12 /* STYLE, PROPS */, ["src"])
              : createCommentVNode("v-if", true)
...
const GenPagesComponentCameraCameraStyles = [utsMapOf([["uni-title", padStyleMapOf(utsMapOf([["paddingTop", 10], ["paddingRight", 0], ["paddingBottom", 10], ["paddingLeft", 0]]))], ["uni-title-text", padStyleMapOf(utsMapOf([["fontSize", 15], ["fontWeight", "bold"]]))], ["uni-camera-wrapper", padStyleMapOf(utsMapOf([["display", "flex"], ["paddingTop", 8], ["paddingRight", 13], ["paddingBottom", 8], ["paddingLeft", 13], ["marginTop", 5], ["marginRight", 0], ["marginBottom", 5], ["marginLeft", 0], ["flexDirection", "row"], ["flexWrap", "nowrap"], ["backgroundColor", "#ffffff"]]))], ["uni-camera-test-host", padStyleMapOf(utsMapOf([["height", 28], ["paddingTop", 0], ["paddingRight", 0], ["paddingBottom", 0], ["paddingLeft", 0], ["flex", 1], ["backgroundColor", "#ffffff"]]))], ["uni-camera-test-host-without-flex", padStyleMapOf(utsMapOf([["height", 28], ["paddingTop", 0], ["paddingRight", 0], ["paddingBottom", 0], ["paddingLeft", 0], ["backgroundColor", "#ffffff"]]))], ["uni-title-size", padStyleMapOf(utsMapOf([["fontSize", 22]]))]])]
