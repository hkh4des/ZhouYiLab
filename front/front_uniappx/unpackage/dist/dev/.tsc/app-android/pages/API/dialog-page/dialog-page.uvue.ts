    ...
    createElementVNode("view", utsMapOf({ class: "uni-padding-wrap" }), [
      ...
      _ctx.width != null
        ? createElementVNode("view", utsMapOf({
            ...
            "width: ",
            createElementVNode("text", utsMapOf({ id: "page-width" }), toDisplayString(_ctx.width!), 1 /* TEXT */)
          ])
        : createCommentVNode("v-if", true),
      _ctx.height != null
        ? createElementVNode("view", utsMapOf({
            ...
            "height: ",
            createElementVNode("text", utsMapOf({ id: "page-height" }), toDisplayString(_ctx.height!), 1 /* TEXT */)
          ])
        : createCommentVNode("v-if", true),
      _ctx.statusBarHeight != null
        ? createElementVNode("view", utsMapOf({
            ...
            "statusBarHeight: ",
            createElementVNode("text", utsMapOf({ id: "page-statusBarHeight" }), toDisplayString(_ctx.statusBarHeight!), 1 /* TEXT */)
          ])
        : createCommentVNode("v-if", true),
...
const GenPagesAPIDialogPageDialogPageStyles = [utsMapOf([["uni-padding-wrap", padStyleMapOf(utsMapOf([["paddingBottom", "var(--uni-safe-area-inset-bottom)"]]))], ["ml-10", padStyleMapOf(utsMapOf([["marginLeft", 10]]))], ["choose-open-animation-type-title", padStyleMapOf(utsMapOf([["fontWeight", "bold"]]))], ["choose-open-animation-type-radio-group", padStyleMapOf(utsMapOf([["flexDirection", "row"], ["flexWrap", "wrap"], ["marginBottom", 20]]))], ["flex-row", padStyleMapOf(utsMapOf([["flexDirection", "row"], ["flexWrap", "wrap"]]))]])]
