...
const _cache = this.$.renderCache
  return createElementVNode(Fragment, null, [
    ...
    createElementVNode("button", utsMapOf({ onClick: _ctx.evalJS }), "evalJS", 8 /* PROPS */, ["onClick"]),
    createElementVNode("view", utsMapOf({ class: "safe-area-inset-bottom" }))
  ], 64 /* STABLE_FRAGMENT */)
}
const GenPagesComponentWebViewWebViewWebViewLocalStyles = [utsMapOf([["web-view", padStyleMapOf(utsMapOf([["flex", 1]]))], ["safe-area-inset-bottom", padStyleMapOf(utsMapOf([["height", "var(--uni-safe-area-inset-bottom)"]]))]])]
