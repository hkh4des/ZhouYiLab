...
const _component_switch = resolveComponent("switch")
  ...
  return createElementVNode("view", utsMapOf({ class: "uni-container" }), [
    createVNode(_component_page_head, utsMapOf({ title: title })),
    createElementVNode("view", utsMapOf({ class: "uni-common-mt" }), [
      createElementVNode("text", utsMapOf({ class: "uni-title" }), "截屏状态：" + toDisplayString(unref(captureStatus)), 1 /* TEXT */),
      createElementVNode("view", utsMapOf({
        style: normalizeStyle(utsMapOf({"flex-direction":"row"}))
      }), [
        createElementVNode("text", utsMapOf({ class: "uni-title" }), "是否允许截屏"),
