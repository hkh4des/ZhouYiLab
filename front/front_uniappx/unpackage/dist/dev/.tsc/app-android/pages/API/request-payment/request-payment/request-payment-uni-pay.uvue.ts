...
const _component_uni_pay = resolveEasyComponent("uni-pay",_easycom_uni_pay)
  ...
  return createElementVNode("view", utsMapOf({ class: "app" }), [
    createElementVNode("view", utsMapOf({ class: "uni-common-mb" }), [
      createElementVNode("text", null, "如对当前页面的支付示例功能有任何疑问，通过电子邮件：service@dcloud.io 联系我们")
    ]),
    errMsg.value != ''
      ? createElementVNode("view", utsMapOf({ key: 0 }), [
          createElementVNode("text", utsMapOf({ class: "err-msg" }), "注意：" + toDisplayString(errMsg.value), 1 /* TEXT */)
        ])
    ...
    createElementVNode("view", null, [
      ...
      createElementVNode("view", null, [
        createElementVNode("input", utsMapOf({
          ...
          onInput: ($event: InputEvent) => {(out_trade_no).value = $event.detail.value},
    ...
    createElementVNode("view", null, [
      ...
      createElementVNode("view", null, [
        createElementVNode("input", utsMapOf({
          ...
          onInput: ($event: InputEvent) => {(total_fee).value = $event.detail.value}
        }), null, 40 /* PROPS, NEED_HYDRATION */, ["modelValue", "onInput"])
      ])
    ]),
        ...
        createElementVNode("scroll-view", utsMapOf({
          ...
          createElementVNode("view", utsMapOf({ class: "mt20" }), [
            createElementVNode("input", utsMapOf({
              ...
              onInput: ($event: InputEvent) => {(transaction_id).value = $event.detail.value},
              placeholder: "请输入"
            }), null, 40 /* PROPS, NEED_HYDRATION */, ["modelValue", "onInput"]),
            createElementVNode("view", null, [
                ...
                createElementVNode("view", utsMapOf({ class: "table" }), [
                  createElementVNode("view", utsMapOf({ class: "table-tr" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "table-td" }), [
                      createElementVNode("text", utsMapOf({ class: "text align-right" }), toDisplayString(getOrderRes.value['description']), 1 /* TEXT */)
                    ])
                  ]),
                  createElementVNode("view", utsMapOf({ class: "table-tr" }), [
                    createElementVNode("view", utsMapOf({ class: "table-td label" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "table-td" }), [
                      createElementVNode("text", utsMapOf({ class: "text align-right" }), toDisplayString(amountFormat(getOrderRes.value.getNumber('total_fee'))), 1 /* TEXT */)
                    ])
                  ]),
                  createElementVNode("view", utsMapOf({ class: "table-tr" }), [
                    createElementVNode("view", utsMapOf({ class: "table-td label" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "table-td" }), [
                      createElementVNode("text", utsMapOf({ class: "text align-right" }), toDisplayString(providerFormat(getOrderRes.value['provider'] as string)), 1 /* TEXT */)
                    ])
                  ]),
                  createElementVNode("view", utsMapOf({ class: "table-tr" }), [
                    createElementVNode("view", utsMapOf({ class: "table-td label" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "table-td" }), [
                      createElementVNode("text", utsMapOf({ class: "text align-right" }), toDisplayString(getOrderRes.value['transaction_id']), 1 /* TEXT */)
                    ])
                  ]),
                  createElementVNode("view", utsMapOf({ class: "table-tr" }), [
                    createElementVNode("view", utsMapOf({ class: "table-td label" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "table-td" }), [
                      createElementVNode("text", utsMapOf({ class: "text align-right" }), toDisplayString(getOrderRes.value['out_trade_no']), 1 /* TEXT */)
                    ])
                  ]),
                  createElementVNode("view", utsMapOf({ class: "table-tr" }), [
                    createElementVNode("view", utsMapOf({ class: "table-td label" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "table-td" }), [
                      createElementVNode("text", utsMapOf({ class: "text align-right" }), toDisplayString(getOrderRes.value.getBoolean('user_order_success') != null && getOrderRes.value.getBoolean('user_order_success') == true ? "成功" : "异常"), 1 /* TEXT */)
                    ])
                  ])
                ])
              ])
...
const GenPagesAPIRequestPaymentRequestPaymentRequestPaymentUniPayStyles = [utsMapOf([["app", padStyleMapOf(utsMapOf([["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15]]))], ["input", padStyleMapOf(utsMapOf([["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#f3f3f3"], ["borderRightColor", "#f3f3f3"], ["borderBottomColor", "#f3f3f3"], ["borderLeftColor", "#f3f3f3"], ["paddingTop", 5], ["paddingRight", 5], ["paddingBottom", 5], ["paddingLeft", 5], ["width", "100%"], ["boxSizing", "border-box"], ["height", 40], ["backgroundImage", "none"], ["backgroundColor", "#FFFFFF"]]))], ["button", padStyleMapOf(utsMapOf([["marginTop", 10]]))], ["label", utsMapOf([["", utsMapOf([["marginTop", 5], ["marginRight", 0], ["marginBottom", 5], ["marginLeft", 0]])], [".table ", utsMapOf([["width", 90]])]])], ["tips", padStyleMapOf(utsMapOf([["marginTop", 10], ["marginRight", 0], ["marginBottom", 10], ["marginLeft", 0], ["fontSize", 12], ["color", "#565656"]]))], ["get-order-popup", padStyleMapOf(utsMapOf([["backgroundColor", "#ffffff"], ["paddingTop", 15], ["paddingRight", 15], ["paddingBottom", 15], ["paddingLeft", 15], ["height", 450], ["borderTopLeftRadius", 10], ["borderTopRightRadius", 10], ["borderBottomRightRadius", 10], ["borderBottomLeftRadius", 10], ["width", "100%"]]))], ["mt20", padStyleMapOf(utsMapOf([["marginTop", 10]]))], ["pd2030", padStyleMapOf(utsMapOf([["paddingTop", 10], ["paddingRight", 15], ["paddingBottom", 10], ["paddingLeft", 15]]))], ["table-tr", utsMapOf([[".table ", utsMapOf([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "center"], ["alignItems", "center"], ["paddingTop", 5], ["paddingRight", 0], ["paddingBottom", 5], ["paddingLeft", 0]])]])], ["table-td", utsMapOf([[".table ", utsMapOf([["flex", 1]])]])], ["align-left", utsMapOf([[".table ", utsMapOf([["textAlign", "left"]])]])], ["align-right", utsMapOf([[".table ", utsMapOf([["textAlign", "right"]])]])], ["text", utsMapOf([[".table ", utsMapOf([["fontSize", 12]])]])], ["err-msg", padStyleMapOf(utsMapOf([["color", "#FF0000"], ["fontSize", 14]]))]])]
