    ...
    createElementVNode("view", utsMapOf({
      ...
      isTrue(!_ctx.hasLeftWin)
        ? createElementVNode("view", utsMapOf({
            ...
            createElementVNode("text", utsMapOf({ class: "hello-text" }), "uni-app x内置组件，展示样式仅供参考，文档详见："),
...
const GenPagesTabBarComponentStyles = [utsMapOf([["pl", padStyleMapOf(utsMapOf([["paddingLeft", 18]]))]])]
