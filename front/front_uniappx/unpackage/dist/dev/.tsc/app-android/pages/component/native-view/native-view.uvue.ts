...
const _component_native_button_container = resolveEasyComponent("native-button-container",_easycom_native_button_container)
  ...
  return createElementVNode("scroll-view", utsMapOf({
    ...
    createElementVNode("view", utsMapOf({
      style: normalizeStyle(utsMapOf({"padding-bottom":"50px"}))
    }), [
...
const GenPagesComponentNativeViewNativeViewStyles = [utsMapOf([["tips", padStyleMapOf(utsMapOf([["fontSize", 14], ["color", "#BEBEBE"], ["marginTop", 25], ["marginRight", "auto"], ["marginBottom", 25], ["marginLeft", "auto"], ["textAlign", "center"]]))], ["native-button", padStyleMapOf(utsMapOf([["height", 100], ["width", 100], ["marginTop", 25], ["marginRight", "auto"], ["marginBottom", 25], ["marginLeft", "auto"]]))]])]
