...
const _component_switch = resolveComponent("switch")
  ...
  return createElementVNode("view", utsMapOf({ class: "uni-flex-item" }), [
    createElementVNode("web-view", utsMapOf({
      id: "web-view",
      class: "uni-flex-item",
      style: normalizeStyle(_ctx.webViewStyle),
      src: _ctx.src,
    ...
    createElementVNode("view", utsMapOf({ class: "uni-padding-wrap uni-common-mt" }), [
      ...
      createElementVNode("view", utsMapOf({ class: "uni-btn-v" }), [
        createVNode(_component_navigator, utsMapOf({ url: "/pages/component/web-view/web-view-scroll" }), utsMapOf({
          default: withSlotCtx((): any[] => [
            createElementVNode("button", utsMapOf({ type: "primary" }), "scroll-view嵌套web-view")
          ]),
          _: 1 /* STABLE */
        }))
      ]),
    ...
    createElementVNode("view", utsMapOf({ class: "safe-area-inset-bottom" }))
  ])
}
const GenPagesComponentWebViewWebViewStyles = [utsMapOf([["margin-left-5", padStyleMapOf(utsMapOf([["marginLeft", 5]]))], ["align-items-center", padStyleMapOf(utsMapOf([["alignItems", "center"]]))], ["safe-area-inset-bottom", padStyleMapOf(utsMapOf([["height", "var(--uni-safe-area-inset-bottom)"]]))]])]
