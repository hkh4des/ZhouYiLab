...
const _component_page_head = resolveEasyComponent("page-head",_easycom_page_head)
  ...
  return createElementVNode("scroll-view", utsMapOf({ class: "uni-flex-item uni-padding-wrap" }), [
    createVNode(_component_page_head, utsMapOf({ title: title })),
    createElementVNode("view", utsMapOf({ class: "uni-title" }), [
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), "无约束宽高"),
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), toDisplayString(unref(info)), 1 /* TEXT */)
    ]),
    ...
    createElementVNode("view", utsMapOf({ class: "uni-title" }), [
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), "约束宽高-多行"),
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), toDisplayString(unref(info2)), 1 /* TEXT */)
    ]),
    ...
    createElementVNode("view", utsMapOf({ class: "uni-title" }), [
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), "约束宽高-单行"),
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), toDisplayString(unref(info3)), 1 /* TEXT */)
    ]),
    createElementVNode("view", utsMapOf({ class: "text-box" }), [
      createElementVNode("text", utsMapOf({
        id: "text3",
    ...
    createElementVNode("view", utsMapOf({ class: "uni-title" }), [
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), "嵌套"),
      createElementVNode("text", utsMapOf({ class: "uni-subtitle-text" }), toDisplayString(unref(info4)), 1 /* TEXT */)
    ]),
    createElementVNode("view", utsMapOf({ class: "text-box" }), [
      createElementVNode("text", utsMapOf({
        id: "text4",
...
const GenPagesComponentTextTextLayoutStyles = [utsMapOf([["text-box", padStyleMapOf(utsMapOf([["alignItems", "center"]]))], ["text", padStyleMapOf(utsMapOf([["backgroundColor", "#ffffff"]]))]])]
