...
const _cache = this.$.renderCache
  return createElementVNode("view", utsMapOf({
    ...
    createElementVNode("view", utsMapOf({
      style: normalizeStyle(utsMapOf({"height":"500px","padding":"0 30px","background-color":"gray","justify-content":"center"}))
    }), [
      ...
      createElementVNode("view", utsMapOf({
        ...
        createElementVNode("text", utsMapOf({ class: "font-weight-bold" }), "white-space: nowrap"),
        createElementVNode("text", utsMapOf({
          class: "font-size-20",
      ...
      createElementVNode("view", utsMapOf({ class: "margin-bottom-10" }), [
        createElementVNode("text", utsMapOf({ class: "font-weight-bold" }), "任意宽度截断（100px、200px、300px）"),
        createElementVNode("text", utsMapOf({
          class: "font-size-20",
          style: normalizeStyle(utsMapOf({"text-overflow":"ellipsis","white-space":"nowrap","width":"100px"}))
        }), toDisplayString(_ctx.multiLineText), 5 /* TEXT, STYLE */),
        createElementVNode("text", utsMapOf({
          class: "font-size-20",
          style: normalizeStyle(utsMapOf({"text-overflow":"ellipsis","white-space":"nowrap","width":"200px"}))
        }), toDisplayString(_ctx.multiLineText), 5 /* TEXT, STYLE */),
        createElementVNode("text", utsMapOf({
          class: "font-size-20",
          style: normalizeStyle(utsMapOf({"text-overflow":"ellipsis","white-space":"nowrap","width":"300px"}))
        }), toDisplayString(_ctx.multiLineText), 5 /* TEXT, STYLE */)
      ]),
      createElementVNode("view", utsMapOf({ class: "margin-bottom-10" }), [
        createElementVNode("text", utsMapOf({ class: "font-weight-bold" }), "lines:1 text-overflow:ellipsis"),
        createElementVNode("text", utsMapOf({
          class: "font-size-20",
          style: normalizeStyle(utsMapOf({"text-overflow":"ellipsis","lines":"1"}))
        }), toDisplayString(_ctx.multiLineText), 5 /* TEXT, STYLE */)
      ])
    ], 4 /* STYLE */)
  ], 4 /* STYLE */)
