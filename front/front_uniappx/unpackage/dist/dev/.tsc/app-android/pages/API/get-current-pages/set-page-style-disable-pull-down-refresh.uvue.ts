...
// @ts-expect-error 
override __$getOriginalPosition(): UTSSourceMapPosition { return new UTSSourceMapPosition("Page", "pages/API/get-current-pages/set-page-style-disable-pull-down-refresh.uvue", 18, 9);}
