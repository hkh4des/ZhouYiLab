...
const _component_uni_recycle_view = resolveEasyComponent("uni-recycle-view",_easycom_uni_recycle_view)
  ...
  return createElementVNode("view", utsMapOf({
    ...
    createElementVNode("view", utsMapOf({ class: "tips" }), "滚动期间对子组件回收复用。此示例限制列表子项固定高度。注意回收复用引发的副作用，详情参考custom-recycle-view-buttons组件内的错误用法。"),
    createVNode(_component_uni_recycle_view, utsMapOf({
          ...
          return createVNode(_component_uni_recycle_item, utsMapOf({
            ...
            default: withSlotCtx((): any[] => [
              createElementVNode("view", utsMapOf({ class: "item-wrapper" }), [
                    ...
                    createElementVNode("view", utsMapOf({ class: "item-content" }), [
                      ...
                      createElementVNode("view", utsMapOf({ class: "item-text" }), [
                        createElementVNode("view", null, [
                          createElementVNode("text", utsMapOf({ class: "item-name" }), toDisplayString(item.name), 1 /* TEXT */)
                        ]),
                        createElementVNode("view", null, [
                          createElementVNode("text", utsMapOf({ class: "item-info" }), toDisplayString(item.name.length % 2 == 0 ? "name长度为偶数" : "name长度为奇数"), 1 /* TEXT */)
                        ]),
                        createElementVNode("view", null, [
                          createElementVNode("text", utsMapOf({ class: "item-info" }), toDisplayString(item.info), 1 /* TEXT */)
                        ]),
                        createElementVNode("view", null, [
                          createElementVNode("text", utsMapOf({ class: "item-info" }), toDisplayString(item.info.length % 2 == 0 ? "info长度为偶数" : "info长度为奇数"), 1 /* TEXT */)
                        ]),
                        createElementVNode("view", null, [
                          createElementVNode("text", utsMapOf({ class: "item-info" }), toDisplayString((item.info.length +item.name.length) % 2 == 0 ? "name+info长度为偶数" : "name+info长度为奇数"), 1 /* TEXT */)
                        ]),
                        item.tags.length > 0
                          ? createElementVNode("view", utsMapOf({
                              ...
                              createElementVNode("text", utsMapOf({ class: "item-info" }), "随机tag："),
                              createElementVNode(Fragment, null, RenderHelpers.renderList(item.tags, (tag, index, __index, _cached): any => {
                ...
                createVNode(_component_custom_recycle_view_buttons, utsMapOf({
                  name: item.name
                }), null, 8 /* PROPS */, ["name"])
              ])
            ]),
      ...
      "load-more": withSlotCtx((): any[] => [
        createElementVNode("view", utsMapOf({ class: "load-more" }), [
          createElementVNode("text", utsMapOf({ class: "load-more-text" }), toDisplayString(unref(hasMore) ? "加载中..." : "没有更多"), 1 /* TEXT */)
        ])
      ]),
      _: 1 /* STABLE */
...
const GenPagesTemplateCustomLongListCustomLongListStyles = [utsMapOf([["tips", padStyleMapOf(utsMapOf([["marginTop", 10], ["marginRight", 10], ["marginBottom", 10], ["marginLeft", 10], ["borderTopLeftRadius", 5], ["borderTopRightRadius", 5], ["borderBottomRightRadius", 5], ["borderBottomLeftRadius", 5], ["paddingTop", 10], ["paddingRight", 10], ["paddingBottom", 10], ["paddingLeft", 10], ["backgroundColor", "#FFFFFF"]]))], ["item-wrapper", padStyleMapOf(utsMapOf([["height", 140], ["justifyContent", "center"], ["boxSizing", "border-box"], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "#cccccc"], ["paddingTop", 0], ["paddingRight", 15], ["paddingBottom", 0], ["paddingLeft", 15]]))], ["item-content", padStyleMapOf(utsMapOf([["display", "flex"], ["flexDirection", "row"], ["alignItems", "flex-start"]]))], ["item-image", padStyleMapOf(utsMapOf([["width", 80], ["height", 80]]))], ["item-text", padStyleMapOf(utsMapOf([["flexDirection", "column"], ["marginLeft", 5]]))], ["item-name", padStyleMapOf(utsMapOf([["fontSize", 14]]))], ["item-info", padStyleMapOf(utsMapOf([["fontSize", 12], ["color", "#999999"]]))], ["item-tags", padStyleMapOf(utsMapOf([["display", "flex"], ["flexDirection", "row"], ["alignItems", "center"]]))], ["item-tag", padStyleMapOf(utsMapOf([["backgroundColor", "#F0F8FF"], ["color", "#999999"], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#999999"], ["borderRightColor", "#999999"], ["borderBottomColor", "#999999"], ["borderLeftColor", "#999999"], ["borderTopLeftRadius", 3], ["borderTopRightRadius", 3], ["borderBottomRightRadius", 3], ["borderBottomLeftRadius", 3], ["paddingTop", 0], ["paddingRight", 2], ["paddingBottom", 0], ["paddingLeft", 2], ["fontSize", 12], ["lineHeight", "16px"], ["marginRight", 2]]))], ["load-more-text", padStyleMapOf(utsMapOf([["color", "#cccccc"], ["fontSize", 12], ["textAlign", "center"], ["lineHeight", "50px"]]))]])]
