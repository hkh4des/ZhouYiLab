  ...
  class Page  implements IUTSSourceMap{
// @ts-expect-error 
override __$getOriginalPosition(): UTSSourceMapPosition { return new UTSSourceMapPosition("Page", "pages/API/get-current-pages/get-current-pages.uvue", 84, 9);}
