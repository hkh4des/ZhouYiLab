  ...
  const __sfc__ = defineComponent({
    ...
    onReady() {
      ...
      var that = this
      class ThreadRunnable extends Runnable  implements IUTSSourceMap{
// @ts-expect-error 
override __$getOriginalPosition(): UTSSourceMapPosition { return new UTSSourceMapPosition("ThreadRunnable", "pages/component/global-events/transition-events.uvue", 29, 13);}
...
const GenPagesComponentGlobalEventsTransitionEventsStyles = [utsMapOf([["adjust", padStyleMapOf(utsMapOf([["marginTop", 10], ["marginRight", 10], ["marginBottom", 10], ["marginLeft", 10]]))], ["transition-transform", padStyleMapOf(utsMapOf([["width", 200], ["height", 200], ["marginTop", 25], ["marginRight", "auto"], ["marginBottom", 25], ["marginLeft", "auto"], ["borderTopLeftRadius", 100], ["borderTopRightRadius", 100], ["borderBottomRightRadius", 100], ["borderBottomLeftRadius", 100], ["transitionProperty", "transform"], ["transitionTimingFunction", "linear"], ["transform", "rotate(0deg)"]]))], ["@TRANSITION", utsMapOf([["transition-transform", utsMapOf([["property", "transform"], ["timingFunction", "linear"]])]])]])]
