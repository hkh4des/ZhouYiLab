import 'F:/program/HBuilderX.4.66.2025051912/HBuilderX/plugins/uniapp-cli-vite/node_modules/@dcloudio/uni-console/src/runtime/app/index.ts';// 仅测试 console.log 时机问题
...
export function createApp() {
  ...
  //   onReady() {
  //     setTimeout(() => {
  //       __f__('log','at main.uts:29',(this as BasePage).$nativePage!.getDomJson())
  //     }, 100)
  //   }
  // })
  return {
...
export class UniAppConfig extends io.dcloud.uniapp.appframe.AppConfig {
    override name: string = "front_uniappx"
    override appid: string = "__UNI__740BA18"
...
import GenPagesComponentViewIssue19746Class from './pages/component/view/issue-19746.uvue?type=page'
import GenPagesComponentViewIssue20486Class from './pages/component/view/issue-20486.uvue?type=page'
import GenPagesComponentViewIssue21144Class from './pages/component/view/issue-21144.uvue?type=page'
...
import GenPagesComponentScrollViewIssue18587Class from './pages/component/scroll-view/issue-18587.uvue?type=page'
import GenPagesComponentScrollViewIssue18773Class from './pages/component/scroll-view/issue-18773.uvue?type=page'
import GenPagesComponentSwiperSwiperClass from './pages/component/swiper/swiper.uvue?type=page'
import GenPagesComponentSwiperSwiperAnimClass from './pages/component/swiper/swiper-anim.uvue?type=page'
import GenPagesComponentMatchMediaMatchMediaClass from './pages/component/match-media/match-media.uvue?type=page'
...
import GenPagesComponentListViewListViewLongPressClass from './pages/component/list-view/list-view-long-press.uvue?type=page'
...
import GenPagesComponentListViewListViewChildrenIfShowClass from './pages/component/list-view/list-view-children-if-show.uvue?type=page'
...
import GenPagesComponentStickySectionIssues16118Class from './pages/component/sticky-section/issues-16118.uvue?type=page'
import GenPagesComponentListViewIssue20688Class from './pages/component/list-view/issue-20688.uvue?type=page'
...
import GenPagesComponentTextIssues18068Class from './pages/component/text/issues18068.uvue?type=page'
import GenPagesComponentTextTextPropsClass from './pages/component/text/text-props.uvue?type=page'
import GenPagesComponentTextTextLayoutClass from './pages/component/text/text-layout.uvue?type=page'
...
import GenPagesComponentRichTextRichTextListClass from './pages/component/rich-text/rich-text-list.uvue?type=page'
...
import GenPagesComponentPickerViewWrapPickerViewClass from './pages/component/picker-view/wrap-picker-view.uvue?type=page'
...
import GenPagesComponentVideoVideoDialogPageClass from './pages/component/video/video-dialog-page.uvue?type=page'
...
import GenPagesComponentWebViewWebViewScrollClass from './pages/component/web-view/web-view-scroll.uvue?type=page'
...
import GenPagesComponentGlobalEventsIssue17662Class from './pages/component/global-events/issue-17662.uvue?type=page'
...
import GenPagesComponentGlobalEventsGlobalEventsTransformClass from './pages/component/global-events/global-events-transform.uvue?type=page'
...
import GenPagesComponentGlobalEventsTouchEventsCaseClass from './pages/component/global-events/touch-events-case.uvue?type=page'
import GenPagesComponentGlobalEventsTouchEventsPreventDefaultClass from './pages/component/global-events/touch-events-preventDefault.uvue?type=page'
...
import GenPagesComponentCoverViewCoverViewClass from './pages/component/cover-view/cover-view.uvue?type=page'
import GenPagesComponentListViewIssue17030Class from './pages/component/list-view/issue-17030.uvue?type=page'
import GenPagesComponentListViewIssue2199Class from './pages/component/list-view/issue-2199.uvue?type=page'
import GenPagesComponentListViewIssue15701Class from './pages/component/list-view/issue-15701.uvue?type=page'
import GenPagesComponentListViewIssue13858Class from './pages/component/list-view/issue-13858.uvue?type=page'
import GenPagesComponentListViewIssue16126Class from './pages/component/list-view/issue-16126.uvue?type=page'
import GenPagesComponentListViewIssue16938Class from './pages/component/list-view/issue-16938.uvue?type=page'
import GenPagesComponentListViewIssue15878Class from './pages/component/list-view/issue-15878.uvue?type=page'
...
import GenPagesComponentWaterflowWaterflowFitHeightClass from './pages/component/waterflow/waterflow-fit-height.uvue?type=page'
import GenPagesComponentAdListViewAdClass from './pages/component/ad/list-view-ad.uvue?type=page'
import GenPagesComponentAdVideoAdClass from './pages/component/ad/video-ad.uvue?type=page'
import GenPagesComponentAdPortraitVideoAdClass from './pages/component/ad/portrait-video-ad.uvue?type=page'
import GenPagesComponentAdLandscapeVideoAdClass from './pages/component/ad/landscape-video-ad.uvue?type=page'
import GenPagesComponentShareElementShareElementClass from './pages/component/share-element/share-element.uvue?type=page'
import GenPagesComponentShareElementShareElementWithSwiperClass from './pages/component/share-element/share-element-with-swiper.uvue?type=page'
import GenPagesComponentShareElementShareElementToClass from './pages/component/share-element/share-element-to.uvue?type=page'
import GenPagesComponentCameraCameraClass from './pages/component/camera/camera.uvue?type=page'
import GenPagesComponentCameraCameraScanCodeClass from './pages/component/camera/camera-scan-code.uvue?type=page'
import GenPagesComponentLivePlayerLivePlayerClass from './pages/component/live-player/live-player.uvue?type=page'
import GenPagesComponentLivePusherLivePusherClass from './pages/component/live-pusher/live-pusher.uvue?type=page'
...
import GenPagesAPINavigatorNewPageOnLoadCallApiClass from './pages/API/navigator/new-page/onLoad-call-api.uvue?type=page'
...
import GenPagesAPIStorageStoragemanageClass from './pages/API/storage/storagemanage.uvue?type=page'
import GenPagesAPIEnvEnvClass from './pages/API/env/env.uvue?type=page'
import GenPagesAPIActionSheetActionSheetClass from './pages/API/action-sheet/action-sheet.uvue?type=page'
import GenPagesAPIModalModalClass from './pages/API/modal/modal.uvue?type=page'
import GenPagesAPILoadingLoadingClass from './pages/API/loading/loading.uvue?type=page'
import GenPagesAPIToastToastClass from './pages/API/toast/toast.uvue?type=page'
...
import GenPagesAPILocationChangeLocationChangeClass from './pages/API/location-change/location-change.uvue?type=page'
...
import GenPagesAPIConnectEventSourceConnectEventSourceClass from './pages/API/connect-event-source/connect-event-source.uvue?type=page'
...
import GenPagesAPIUnicloudUnicloudSseChannelClass from './pages/API/unicloud/unicloud/sse-channel.uvue?type=page'
...
import GenPagesAPIChooseMediaChooseMediaClass from './pages/API/choose-media/choose-media.uvue?type=page'
import GenPagesAPIChooseMediaFullscreenVideoClass from './pages/API/choose-media/fullscreen-video.uvue?type=page'
import GenPagesAPIChooseFileChooseFileClass from './pages/API/choose-file/choose-file.uvue?type=page'
import GenPagesAPIGetNetworkTypeGetNetworkTypeClass from './pages/API/get-network-type/get-network-type.uvue?type=page'
import GenPagesAPINetworkStatusChangeNetworkStatusChangeClass from './pages/API/network-status-change/network-status-change.uvue?type=page'
...
import GenPagesAPIElementRequestFullscreenElementRequestFullscreenClass from './pages/API/element-request-fullscreen/element-request-fullscreen.uvue?type=page'
import GenPagesAPIElementRequestFullscreenElementRequestFullscreenBugsClass from './pages/API/element-request-fullscreen/element-request-fullscreen-bugs.uvue?type=page'
...
import GenPagesAPIGetUniVerifyManagerGetUniVerifyManagerClass from './pages/API/get-uni-verify-manager/get-uni-verify-manager.uvue?type=page'
import GenPagesAPIGetUniVerifyManagerUniVerifyCustomPageClass from './pages/API/get-uni-verify-manager/uni-verify-custom-page.uvue?type=page'
import GenPagesAPIGetUniVerifyManagerFullWebviewPageClass from './pages/API/get-uni-verify-manager/full-webview-page.uvue?type=page'
...
import GenPagesAPIRequestMerchantTransferRequestMerchantTransferClass from './pages/API/request-merchant-transfer/request-merchant-transfer.uvue?type=page'
...
import GenPagesAPIMakePhoneCallMakePhoneCallClass from './pages/API/make-phone-call/make-phone-call.uvue?type=page'
import GenPagesAPIClipboardClipboardClass from './pages/API/clipboard/clipboard.uvue?type=page'
import GenPagesAPIScanCodeScanCodeClass from './pages/API/scan-code/scan-code.uvue?type=page'
...
import GenPagesAPIAnimateAnimateClass from './pages/API/animate/animate.uvue?type=page'
...
import GenPagesAPIUniResizeObserverUniResizeObserverClass from './pages/API/uni-resize-observer/uni-resize-observer.uvue?type=page'
...
import GenPagesAPIBase64Base64Class from './pages/API/base64/base64.uvue?type=page'
...
import GenPagesAPIDialogPageDialog11Class from './pages/API/dialog-page/dialog-1-1.uvue?type=page'
...
import GenPagesAPIDialogPageDialog5Class from './pages/API/dialog-page/dialog-5.uvue?type=page'
import GenPagesAPIDialogPageDialogTextareaClass from './pages/API/dialog-page/dialog-textarea.uvue?type=page'
import GenPagesAPIDialogPageDialogInputClass from './pages/API/dialog-page/dialog-input.uvue?type=page'
...
import GenPagesAPISetInnerAudioOptionSetInnerAudioOptionClass from './pages/API/set-inner-audio-option/set-inner-audio-option.uvue?type=page'
import GenPagesAPIGetRecorderManagerGetRecorderManagerClass from './pages/API/get-recorder-manager/get-recorder-manager.uvue?type=page'
import GenPagesAPIShareWithSystemShareWithSystemClass from './pages/API/share-with-system/share-with-system.uvue?type=page'
import GenPagesAPIOpenAppAuthorizeSettingOpenAppAuthorizeSettingClass from './pages/API/open-app-authorize-setting/open-app-authorize-setting.uvue?type=page'
import GenPagesAPIIsSimulatorIsSimulatorClass from './pages/API/is-simulator/is-simulator.uvue?type=page'
import GenPagesAPIGetAccessibilityInfoGetAccessibilityInfoClass from './pages/API/get-accessibility-info/get-accessibility-info.uvue?type=page'
import GenPagesAPICaptureScreenCaptureScreenClass from './pages/API/capture-screen/capture-screen.uvue?type=page'
import GenPagesAPIOpenDocumentOpenDocumentClass from './pages/API/open-document/open-document.uvue?type=page'
...
import GenPagesAPIKeyboardKeyboardClass from './pages/API/keyboard/keyboard.uvue?type=page'
import GenPagesAPICreateWorkerCreateWorkerClass from './pages/API/create-worker/create-worker.uvue?type=page'
import GenPagesAPICreateWorkerUtsCreateWorkerClass from './pages/API/create-worker/uts-create-worker.uvue?type=page'
...
import GenPagesComponentNativeViewNativeViewTimePickerDialogClass from './pages/component/native-view/native-view-time-picker-dialog.uvue?type=page'
import GenPagesComponentImageImageLongClass from './pages/component/image/image-long.uvue?type=page'
import GenPagesAPIRequestRequestTaskClass from './pages/API/request/requestTask.uvue?type=page'
...
import GenPagesAPIGetFileSystemManagerFilemanageClass from './pages/API/get-file-system-manager/filemanage.uvue?type=page'
import GenPagesAPIGetFileSystemManagerTestStaticClass from './pages/API/get-file-system-manager/testStatic.uvue?type=page'
...
import GenPagesTemplateNavTransparentNavTransparentClass from './pages/template/nav-transparent/nav-transparent.uvue?type=page'
...
import GenPagesTemplateLongListBatchLongListBatchClass from './pages/template/long-list-batch/long-list-batch.uvue?type=page'
...
import GenPagesTemplateIssue14765Issue14765Class from './pages/template/issue-14765/issue-14765.uvue?type=page'
import GenPagesTemplateTestUtsButtonTestUtsButtonClass from './pages/template/test-uts-button/test-uts-button.uvue?type=page'
import GenPagesTemplateAboutAboutClass from './pages/template/about/about.uvue?type=page'
import GenPagesTemplateCustomLongListDetailClass from './pages/template/custom-long-list/detail.uvue?type=page'
import GenPagesCSSBackgroundBackgroundColorClass from './pages/CSS/background/background-color.uvue?type=page'
import GenPagesCSSBackgroundBackgroundColorCheckBoxClass from './pages/CSS/background/background-color-check-box.uvue?type=page'
...
import GenPagesCSSTextWhiteSpaceClass from './pages/CSS/text/white-space.uvue?type=page'
...
import GenPagesCSSTextTextShadowClass from './pages/CSS/text/text-shadow.uvue?type=page'
...
import GenPagesCSSPointerEventsIssue20923Class from './pages/CSS/pointer-events/issue-20923.uvue?type=page'
...
import GenPagesCSSOverflowIssue21223Class from './pages/CSS/overflow/issue-21223.uvue?type=page'
import GenPagesCSSTransformTransformOriginClass from './pages/CSS/transform/transform-origin.uvue?type=page'
import GenPagesCSSVariableCustomVariableClass from './pages/CSS/variable/custom_variable.uvue?type=page'
import GenPagesCSSFunctionFunctionClass from './pages/CSS/function/function.uvue?type=page'
import GenPagesCSSTransitionTransitionDurationClass from './pages/CSS/transition/transition-duration.uvue?type=page'
import GenPagesCSSFunctionRgbClass from './pages/CSS/function/rgb.uvue?type=page'
import GenPagesCSSFunctionRgbaClass from './pages/CSS/function/rgba.uvue?type=page'
import GenPagesCSSFunctionUrlClass from './pages/CSS/function/url.uvue?type=page'
function definePageRoutes() {
__uniRoutes.push({ path: "pages/tabBar/component", component: GenPagesTabBarComponentClass, meta: { isQuit: true } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","内置组件"],["backgroundColorContent","@tabBarPagebackgroundColorContent"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/view/issue-19746", component: GenPagesComponentViewIssue19746Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-19746"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/view/issue-20486", component: GenPagesComponentViewIssue20486Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-20486"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/view/issue-21144", component: GenPagesComponentViewIssue21144Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-21144"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/scroll-view/issue-18587", component: GenPagesComponentScrollViewIssue18587Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-18587"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/scroll-view/issue-18773", component: GenPagesComponentScrollViewIssue18773Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-18773"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/swiper/swiper-anim", component: GenPagesComponentSwiperSwiperAnimClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","swiper | 滑块视图容器 - 动画测试"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/match-media/match-media", component: GenPagesComponentMatchMediaMatchMediaClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","match-media | 匹配检测节点"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/list-view/list-view-long-press", component: GenPagesComponentListViewListViewLongPressClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","list-view长按事件"],["enablePullDownRefresh",false]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/list-view/list-view-children-if-show", component: GenPagesComponentListViewListViewChildrenIfShowClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","list-item v-if & v-show"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/sticky-section/issues-16118", component: GenPagesComponentStickySectionIssues16118Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/list-view/issue-20688", component: GenPagesComponentListViewIssue20688Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-20688"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/text/issues18068", component: GenPagesComponentTextIssues18068Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","text | 文本"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/text/text-layout", component: GenPagesComponentTextTextLayoutClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","text-layout"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/rich-text/rich-text-list", component: GenPagesComponentRichTextRichTextListClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","rich-text-list"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/picker-view/wrap-picker-view", component: GenPagesComponentPickerViewWrapPickerViewClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","picker-view | 嵌入页面的滚动选择器"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/video/video-dialog-page", component: GenPagesComponentVideoVideoDialogPageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","test dislogPage video"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/web-view/web-view-scroll", component: GenPagesComponentWebViewWebViewScrollClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","web-view-scroll"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/global-events/issue-17662", component: GenPagesComponentGlobalEventsIssue17662Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-17662"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/global-events/global-events-transform", component: GenPagesComponentGlobalEventsGlobalEventsTransformClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","点击事件-transform"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/global-events/touch-events-case", component: GenPagesComponentGlobalEventsTouchEventsCaseClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","Touch Events case"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/global-events/touch-events-preventDefault", component: GenPagesComponentGlobalEventsTouchEventsPreventDefaultClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","preventDefault"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/cover-view/cover-view", component: GenPagesComponentCoverViewCoverViewClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","cover-view"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/list-view/issue-17030", component: GenPagesComponentListViewIssue17030Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-17030"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/list-view/issue-15701", component: GenPagesComponentListViewIssue15701Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-15701"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/list-view/issue-13858", component: GenPagesComponentListViewIssue13858Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-13858"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/list-view/issue-16126", component: GenPagesComponentListViewIssue16126Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-16126"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/list-view/issue-16938", component: GenPagesComponentListViewIssue16938Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-16938"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/list-view/issue-15878", component: GenPagesComponentListViewIssue15878Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-15878"],["enablePullDownRefresh",false]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/native-view/native-view", component: GenPagesComponentNativeViewNativeViewClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","native-view | 自定义原生View组件"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/waterflow/waterflow-fit-height", component: GenPagesComponentWaterflowWaterflowFitHeightClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","waterflow | 瀑布流容器"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/ad/video-ad", component: GenPagesComponentAdVideoAdClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","ad | 视频贴片"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/ad/portrait-video-ad", component: GenPagesComponentAdPortraitVideoAdClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","ad | 视频贴片竖向全屏"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/ad/landscape-video-ad", component: GenPagesComponentAdLandscapeVideoAdClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","ad | 视频贴片横向全屏"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/share-element/share-element", component: GenPagesComponentShareElementShareElementClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","share-element | 共享元素视图容器"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/share-element/share-element-with-swiper", component: GenPagesComponentShareElementShareElementWithSwiperClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","share-element-with-swiper"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/share-element/share-element-to", component: GenPagesComponentShareElementShareElementToClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/camera/camera", component: GenPagesComponentCameraCameraClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","camera | 相机"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/camera/camera-scan-code", component: GenPagesComponentCameraCameraScanCodeClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","camera-scan-code | 相机扫码"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/live-player/live-player", component: GenPagesComponentLivePlayerLivePlayerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","live-player | 实时音视频播放"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/live-pusher/live-pusher", component: GenPagesComponentLivePusherLivePusherClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","live-pusher | 实时音视频录制"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/tabBar/API", component: GenPagesTabBarAPIClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","接口"],["backgroundColorContent","@tabBarPagebackgroundColorContent"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/exit/exit", component: GenPagesAPIExitExitClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.exit | 退出应用"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/install-apk/install-apk", component: GenPagesAPIInstallApkInstallApkClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.installApk | 安装 APK"],["enablePullDownRefresh",false]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/get-launch-options-sync/get-launch-options-sync", component: GenPagesAPIGetLaunchOptionsSyncGetLaunchOptionsSyncClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getLaunchOptionsSync | 获取启动参数"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-enter-options-sync/get-enter-options-sync", component: GenPagesAPIGetEnterOptionsSyncGetEnterOptionsSyncClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getEnterOptionsSync | 获取本次启动时的参数"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/set-navigation-bar-color/set-navigation-bar-color", component: GenPagesAPISetNavigationBarColorSetNavigationBarColorClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.setNavigationBarColor | 设置导航条颜色"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/set-navigation-bar-title/set-navigation-bar-title", component: GenPagesAPISetNavigationBarTitleSetNavigationBarTitleClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.setNavigationBarTitle | 设置导航条标题"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/navigator/new-page/onLoad-call-api", component: GenPagesAPINavigatorNewPageOnLoadCallApiClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","onLoad call api"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/storage/storagemanage", component: GenPagesAPIStorageStoragemanageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","storage管理器"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/env/env", component: GenPagesAPIEnvEnvClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.env | 环境变量"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/action-sheet/action-sheet", component: GenPagesAPIActionSheetActionSheetClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","actionSheet | 操作菜单"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/modal/modal", component: GenPagesAPIModalModalClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","modal | 模态弹窗"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/loading/loading", component: GenPagesAPILoadingLoadingClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","loading | loading 加载框"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/toast/toast", component: GenPagesAPIToastToastClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","toast | toast 轻提示"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/load-font-face/load-font-face", component: GenPagesAPILoadFontFaceLoadFontFaceClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.loadFontFace | 动态加载字体"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/get-location/get-location", component: GenPagesAPIGetLocationGetLocationClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getLocation | 获取当前位置"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/location-change/location-change", component: GenPagesAPILocationChangeLocationChangeClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","locationChange | 位置更新"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/open-location/open-location", component: GenPagesAPIOpenLocationOpenLocationClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.openLocation | 使用地图查看位置"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/choose-location/choose-location", component: GenPagesAPIChooseLocationChooseLocationClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.chooseLocation | 使用地图选择位置"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/request/request", component: GenPagesAPIRequestRequestClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.request | 发起网络请求"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/upload-file/upload-file", component: GenPagesAPIUploadFileUploadFileClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.uploadFile | 上传文件"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/download-file/download-file", component: GenPagesAPIDownloadFileDownloadFileClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.downloadFile | 下载文件"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/connect-event-source/connect-event-source", component: GenPagesAPIConnectEventSourceConnectEventSourceClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.connectEventSource | SSE"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/unicloud/unicloud/sse-channel", component: GenPagesAPIUnicloudUnicloudSseChannelClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","SSEChannel | 服务端通知通道"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-system-info/get-system-info", component: GenPagesAPIGetSystemInfoGetSystemInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getSystemInfo | 获取系统信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-device-info/get-device-info", component: GenPagesAPIGetDeviceInfoGetDeviceInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getDeviceInfo | 获取设备信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-app-base-info/get-app-base-info", component: GenPagesAPIGetAppBaseInfoGetAppBaseInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getAppBaseInfo | 获取APP基础信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-system-setting/get-system-setting", component: GenPagesAPIGetSystemSettingGetSystemSettingClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getSystemSetting | 获取系统设置"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/get-app-authorize-setting/get-app-authorize-setting", component: GenPagesAPIGetAppAuthorizeSettingGetAppAuthorizeSettingClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getAppAuthorizeSetting | 获取APP授权设置"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/preview-image/preview-image", component: GenPagesAPIPreviewImagePreviewImageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.previewImage | 图片预览"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/choose-image/choose-image", component: GenPagesAPIChooseImageChooseImageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.chooseImage | 拍照或从相册选择图片"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-image-info/get-image-info", component: GenPagesAPIGetImageInfoGetImageInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getImageInfo | 获取图片信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/compress-image/compress-image", component: GenPagesAPICompressImageCompressImageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.compressImage | 压缩图片"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/choose-video/choose-video", component: GenPagesAPIChooseVideoChooseVideoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.chooseVideo | 拍摄视频或从相册中选择视频"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/compress-video/compress-video", component: GenPagesAPICompressVideoCompressVideoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.compressVideo | 压缩视频"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/choose-media/choose-media", component: GenPagesAPIChooseMediaChooseMediaClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.chooseMedia | 拍摄或从相册选择图片或视频"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/choose-media/fullscreen-video", component: GenPagesAPIChooseMediaFullscreenVideoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationStyle","custom"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/choose-file/choose-file", component: GenPagesAPIChooseFileChooseFileClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.chooseFile | 选择文件"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-network-type/get-network-type", component: GenPagesAPIGetNetworkTypeGetNetworkTypeClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getNetworkType | 获取网络类型"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/network-status-change/network-status-change", component: GenPagesAPINetworkStatusChangeNetworkStatusChangeClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","NetworkStatusChange | 监听网络状态变化"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/page-scroll-to/page-scroll-to", component: GenPagesAPIPageScrollToPageScrollToClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.pageScrollTo | 将页面滚动到指定位置"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/get-battery-info/get-battery-info", component: GenPagesAPIGetBatteryInfoGetBatteryInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getBatteryInfo | 获取电池电量信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-window-info/get-window-info", component: GenPagesAPIGetWindowInfoGetWindowInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getWindowInfo | 获取窗口信息"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/element-request-fullscreen/element-request-fullscreen", component: GenPagesAPIElementRequestFullscreenElementRequestFullscreenClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","requestFullscreen | 请求全屏显示"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/element-request-fullscreen/element-request-fullscreen-bugs", component: GenPagesAPIElementRequestFullscreenElementRequestFullscreenBugsClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","request-fullscreen-bugs"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/get-uni-verify-manager/get-uni-verify-manager", component: GenPagesAPIGetUniVerifyManagerGetUniVerifyManagerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getUniVerifyManager | App一键登录"],["navigationBarTextStyle","white"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-uni-verify-manager/uni-verify-custom-page", component: GenPagesAPIGetUniVerifyManagerUniVerifyCustomPageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTextStyle","black"],["navigationStyle","custom"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-uni-verify-manager/full-webview-page", component: GenPagesAPIGetUniVerifyManagerFullWebviewPageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTextStyle","white"],["navigationStyle","custom"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/rpx2px/rpx2px", component: GenPagesAPIRpx2pxRpx2pxClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.rpx2px | 将rpx单位值转换成px"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/create-request-permission-listener/create-request-permission-listener", component: GenPagesAPICreateRequestPermissionListenerCreateRequestPermissionListenerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createRequestPermissionListener | 监听权限申请"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/request-payment/request-payment", component: GenPagesAPIRequestPaymentRequestPaymentClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.requestPayment | 支付"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/request-merchant-transfer/request-merchant-transfer", component: GenPagesAPIRequestMerchantTransferRequestMerchantTransferClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.requestMerchantTransfer | 转账确认收款"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/create-rewarded-video-ad/create-rewarded-video-ad", component: GenPagesAPICreateRewardedVideoAdCreateRewardedVideoAdClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createRewardedVideoAd | 激励视频广告"],["enablePullDownRefresh",false]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/make-phone-call/make-phone-call", component: GenPagesAPIMakePhoneCallMakePhoneCallClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.makePhoneCall | 打电话"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/clipboard/clipboard", component: GenPagesAPIClipboardClipboardClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","clipboard | 剪切板"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/scan-code/scan-code", component: GenPagesAPIScanCodeScanCodeClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.scanCode | 扫码"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/get-element-by-id/get-element-by-id", component: GenPagesAPIGetElementByIdGetElementByIdClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getElementById | 通过 id 获取 element"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/create-selector-query/create-selector-query", component: GenPagesAPICreateSelectorQueryCreateSelectorQueryClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createSelectorQuery | 创建 SelectorQuery 实例"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/animate/animate", component: GenPagesAPIAnimateAnimateClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","animate | 动画"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/uni-resize-observer/uni-resize-observer", component: GenPagesAPIUniResizeObserverUniResizeObserverClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","UniResizeObserver"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/base64/base64", component: GenPagesAPIBase64Base64Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","Base64"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/uni-push/uni-push", component: GenPagesAPIUniPushUniPushClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni-push示例"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/report/report", component: GenPagesAPIReportReportClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.report | 统计采集上报"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/dialog-page/dialog-1-1", component: GenPagesAPIDialogPageDialog11Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","dialogPage1-1"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/dialog-page/dialog-3", component: GenPagesAPIDialogPageDialog3Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","dialogPage3"],["navigationBarTextStyle","black"],["backgroundColorContent","#007aff"],["navigationStyle","default"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/API/dialog-page/dialog-5", component: GenPagesAPIDialogPageDialog5Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","dialogPage5"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/dialog-page/dialog-textarea", component: GenPagesAPIDialogPageDialogTextareaClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","dialog-textarea"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/dialog-page/dialog-input", component: GenPagesAPIDialogPageDialogInputClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","dialog-input"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/create-interstitial-ad/create-interstitial-ad", component: GenPagesAPICreateInterstitialAdCreateInterstitialAdClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createInterstitialAd | 插屏广告"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-background-audio-manager/get-background-audio-manager", component: GenPagesAPIGetBackgroundAudioManagerGetBackgroundAudioManagerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getBackgroundAudioManager | 背景音频"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/set-inner-audio-option/set-inner-audio-option", component: GenPagesAPISetInnerAudioOptionSetInnerAudioOptionClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.setInnerAudioOption | 音频播放选项"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-recorder-manager/get-recorder-manager", component: GenPagesAPIGetRecorderManagerGetRecorderManagerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getRecorderManager | 录音"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/share-with-system/share-with-system", component: GenPagesAPIShareWithSystemShareWithSystemClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.shareWithSystem | 系统分享"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/open-app-authorize-setting/open-app-authorize-setting", component: GenPagesAPIOpenAppAuthorizeSettingOpenAppAuthorizeSettingClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.openAppAuthorizeSetting | 跳转系统授权管理页"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/is-simulator/is-simulator", component: GenPagesAPIIsSimulatorIsSimulatorClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.isSimulator | 判断是否为模拟器"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-accessibility-info/get-accessibility-info", component: GenPagesAPIGetAccessibilityInfoGetAccessibilityInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getAccessibilityInfo | 获取无障碍服务信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/capture-screen/capture-screen", component: GenPagesAPICaptureScreenCaptureScreenClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","captureScreen | 截屏事件"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/open-document/open-document", component: GenPagesAPIOpenDocumentOpenDocumentClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.openDocument | 打开文档"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-video-info/get-video-info", component: GenPagesAPIGetVideoInfoGetVideoInfoClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getVideoInfo | 获取视频信息"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/save-image-to-photos-album/save-image-to-photos-album", component: GenPagesAPISaveImageToPhotosAlbumSaveImageToPhotosAlbumClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.saveImageToPhotosAlbum | 保存图片到相册"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/save-video-to-photos-album/save-video-to-photos-album", component: GenPagesAPISaveVideoToPhotosAlbumSaveVideoToPhotosAlbumClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.saveVideoToPhotosAlbum | 保存视频到相册"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/keyboard/keyboard", component: GenPagesAPIKeyboardKeyboardClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","keyboard | 键盘"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/create-worker/create-worker", component: GenPagesAPICreateWorkerCreateWorkerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createWorker | 创建 worker 对象"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/create-worker/uts-create-worker", component: GenPagesAPICreateWorkerUtsCreateWorkerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createWorker | UTS插件示例"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/tabBar/CSS", component: GenPagesTabBarCSSClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","CSS"],["backgroundColorContent","@tabBarPagebackgroundColorContent"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/tabBar/template", component: GenPagesTabBarTemplateClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","模板"],["backgroundColorContent","@tabBarPagebackgroundColorContent"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/component/native-view/native-view-time-picker-dialog", component: GenPagesComponentNativeViewNativeViewTimePickerDialogClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/component/image/image-long", component: GenPagesComponentImageImageLongClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/request/requestTask", component: GenPagesAPIRequestRequestTaskClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","requestTask | 发起流式请求"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-file-system-manager/get-file-system-manager", component: GenPagesAPIGetFileSystemManagerGetFileSystemManagerClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.getFileSystemManager | 获取文件管理器"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-file-system-manager/filemanage", component: GenPagesAPIGetFileSystemManagerFilemanageClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","沙盒文件管理器"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/get-file-system-manager/testStatic", component: GenPagesAPIGetFileSystemManagerTestStaticClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","测试文件管理类直接操作Static"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/API/create-inner-audio-context/create-inner-audio-context", component: GenPagesAPICreateInnerAudioContextCreateInnerAudioContextClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","uni.createInnerAudioContext | 音频播放"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/template/nav-transparent/nav-transparent", component: GenPagesTemplateNavTransparentNavTransparentClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","渐变导航栏"],["navigationStyle","custom"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/template/custom-long-list/custom-long-list", component: GenPagesTemplateCustomLongListCustomLongListClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","回收复用长列表"],["enablePullDownRefresh",false]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/template/long-list-batch/long-list-batch", component: GenPagesTemplateLongListBatchLongListBatchClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","分批加载长列表"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/template/issue-14765/issue-14765", component: GenPagesTemplateIssue14765Issue14765Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-14765"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/template/test-uts-button/test-uts-button", component: GenPagesTemplateTestUtsButtonTestUtsButtonClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/template/about/about", component: GenPagesTemplateAboutAboutClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","关于"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/template/custom-long-list/detail", component: GenPagesTemplateCustomLongListDetailClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","测试详情页"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/CSS/background/background-color-check-box", component: GenPagesCSSBackgroundBackgroundColorCheckBoxClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","background-color-check-box"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/CSS/text/white-space", component: GenPagesCSSTextWhiteSpaceClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","white-space"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/CSS/text/text-shadow", component: GenPagesCSSTextTextShadowClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","text-shadow"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/CSS/pointer-events/issue-20923", component: GenPagesCSSPointerEventsIssue20923Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-20923"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/CSS/variable/variable", component: GenPagesCSSVariableVariableClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","预置css变量"],["pageOrientation","auto"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/CSS/overflow/issue-21223", component: GenPagesCSSOverflowIssue21223Class, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","issue-21223"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/transform/transform-origin", component: GenPagesCSSTransformTransformOriginClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","transform-origin"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/variable/custom_variable", component: GenPagesCSSVariableCustomVariableClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","自定义css变量"],["pageOrientation","auto"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/function/function", component: GenPagesCSSFunctionFunctionClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","env 函数"],["pageOrientation","auto"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/transition/transition-duration", component: GenPagesCSSTransitionTransitionDurationClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/function/rgb", component: GenPagesCSSFunctionRgbClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","rgb 函数"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/function/rgba", component: GenPagesCSSFunctionRgbaClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","rgba 函数"]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/CSS/function/url", component: GenPagesCSSFunctionUrlClass, meta: { isQuit: false } as UniPageMeta, style: utsMapOf([["navigationBarTitleText","url 函数"]]) } as UniPageRoute)
}
...
const __uniLaunchPage: Map<string, any | null> = utsMapOf([["url","pages/tabBar/component"],["style",utsMapOf([["navigationBarTitleText","内置组件"],["backgroundColorContent","@tabBarPagebackgroundColorContent"]])]])
