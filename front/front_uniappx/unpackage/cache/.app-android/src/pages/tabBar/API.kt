...
open class GenPagesTabBarAPI : BasePage {
            ...
            createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                ...
                if (isTrue(!_ctx.hasLeftWin)) {
                    createElementVNode("view", utsMapOf("key" to 1, "class" to "uni-text-box"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "hello-text"), "以下将演示uni-app x接口能力，详细文档见："),
                                        ...
                                        return createElementVNode(Fragment, utsMapOf("key" to childMenuItem.id), utsArrayOf(
                                            if (childMenuItem.items.length == 0) {
                                                createElementVNode("view", utsMapOf("key" to 0, "class" to normalizeClass(utsArrayOf(
                                                    "pl",
                                                    utsMapOf("uni-navigate-item" to (childMenuItem.path !== "set-tab-bar" || _ctx.windowWidth <= 768))
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("pl" to padStyleMapOf(utsMapOf("paddingLeft" to 18)), "popup" to padStyleMapOf(utsMapOf("position" to "fixed", "top" to 0, "bottom" to 0, "left" to 0, "right" to 0, "alignItems" to "center", "justifyContent" to "center", "display" to "none", "backgroundColor" to "rgba(16,16,16,0.5)")))
            }
