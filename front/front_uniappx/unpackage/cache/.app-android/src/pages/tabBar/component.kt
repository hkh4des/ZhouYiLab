...
open class GenPagesTabBarComponent : BasePage {
            ...
            createElementVNode("view", utsMapOf("class" to normalizeClass(utsArrayOf(
                ...
                if (isTrue(!_ctx.hasLeftWin)) {
                    createElementVNode("view", utsMapOf("key" to 1, "class" to "uni-text-box"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "hello-text"), "uni-app x内置组件，展示样式仅供参考，文档详见："),
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("menu" to uni.UNI740BA18.menu as UTSArray<MenuItem>, "arrowRightIcon" to "/static/icons/arrow-right.png" as String, "pageHiden" to false, "hasLeftWin" to computed<Boolean>(fun(): Boolean {
