        ...
        return createElementVNode("scroll-view", utsMapOf("class" to "page"), utsArrayOf(
            createElementVNode("view", utsMapOf("class" to "scale-container"), utsArrayOf(
                createElementVNode("view", utsMapOf("class" to "trace"), utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "base reserve"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "reserve-text"), "scaleX(-1)"),
                        createElementVNode("text", utsMapOf("class" to "reserve-text"), "转变前位置")
                    )),
                    createElementVNode("view", utsMapOf("class" to "base reserve"), utsArrayOf(
                        createElementVNode("text", utsMapOf("class" to "reserve-text"), "scaleY(-1)"),
                        createElementVNode("text", utsMapOf("class" to "reserve-text"), "转变前位置")
                    ))
                )),
                ...
                createElementVNode("view", utsMapOf("class" to "base transform", "style" to normalizeStyle(utsMapOf("transform" to "scaleX(-1)"))), utsArrayOf(
                    createElementVNode("text", null, "scaleX(-1)"),
                    createElementVNode("text", null, "转变后位置")
                ), 4),
                createElementVNode("view", utsMapOf("class" to "base transform", "style" to normalizeStyle(utsMapOf("transform" to "scaleY(-1)"))), utsArrayOf(
                    createElementVNode("text", null, "scaleY(-1)"),
                    createElementVNode("text", null, "转变后位置")
                ), 4),
                createElementVNode("view", utsMapOf("class" to "base", "style" to normalizeStyle(utsMapOf("width" to "auto"))), utsArrayOf(
                    createElementVNode("text", null, "通过scaleY(0.5)实现0.5px的线"),
                    createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("width" to "200px", "height" to "1px", "background-color" to "#000", "transform" to "scaleY(0.5)"))), null, 4)
                ), 4)
            ))
        ))
    }
