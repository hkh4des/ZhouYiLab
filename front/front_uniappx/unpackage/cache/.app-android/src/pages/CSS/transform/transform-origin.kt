...
open class GenPagesCSSTransformTransformOrigin : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1"))), utsArrayOf(
            createElementVNode("view", utsMapOf("ref" to "transformView", "class" to "view", "onClick" to _ctx.changetransform), null, 8, utsArrayOf(
                "onClick"
            ))
        ), 4)
    }
