...
open class GenPagesTemplateLongList2LongList2 : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesTemplateLongList2LongList2) -> Any? = fun(__props): Any? {
            ...
            val swiperList = ref(utsArrayOf<SwiperViewItem4>(SwiperViewItem4(type = "UpdatedDate", name = "最新上架", id = "list-id-1", preload = true), SwiperViewItem4(type = "FreeHot", name = "免费热榜", id = "list-id-2", preload = false), SwiperViewItem4(type = "PaymentHot", name = "付费热榜", id = "list-id-3", preload = false), SwiperViewItem4(type = "HotList", name = "热门总榜", id = "list-id-4", preload = false)))
            ...
            val swiperTabsRect = ref(utsArrayOf<SwiperTabsItem3>())
                ...
                return wrapUTSPromise(suspend {
                        ...
                        run {
                            ...
                            while(i < tabs.length){
                                ...
                                swiperTabsRect.value.push(SwiperTabsItem3(x = x, w = w))
                                i++
                            }
                        }
                })
            ...
            return fun(): Any? {
                return createElementVNode("scroll-view", utsMapOf("ref_key" to "pageScrollView", "ref" to pageScrollView, "class" to "page", "bounces" to false, "onStartnestedscroll" to onStartNestedScroll, "onNestedprescroll" to onNestedPreScroll, "nested-scroll-child" to unref(nestedScrollChildId)), utsArrayOf(
