...
open class GenPagesComponentAdPortraitVideoAd : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("class" to "container"), utsArrayOf(
            createElementVNode("video", utsMapOf("id" to "myVideo1", "src" to _ctx.src, "controls" to true, "autoplay" to "false", "class" to "video", "onPlay" to _ctx.onVideoPlay), utsArrayOf(
                if (isTrue(_ctx.adVisible)) {
                    createElementVNode("view", utsMapOf("key" to 0, "class" to "ad-container"), utsArrayOf(
                        createElementVNode("ad", utsMapOf("adpid" to "1597617406", "style" to normalizeStyle(utsMapOf("width" to "100%", "height" to "100%")), "onLoad" to _ctx.loadFun, "onError" to _ctx.errorFun, "onClose" to _ctx.closeAd), null, 44, utsArrayOf(
                            "onLoad",
                            "onError",
                            "onClose"
                        ))
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("container" to padStyleMapOf(utsMapOf("position" to "relative", "width" to "100%", "height" to "100%", "display" to "flex", "flexDirection" to "column", "alignItems" to "center")), "video" to padStyleMapOf(utsMapOf("width" to "100%", "height" to "420rpx")), "ad-container" to padStyleMapOf(utsMapOf("width" to "100%", "height" to "100%", "backgroundColor" to "rgba(0,0,0,0.7)", "display" to "flex", "alignItems" to "center", "justifyContent" to "center")))
            }
