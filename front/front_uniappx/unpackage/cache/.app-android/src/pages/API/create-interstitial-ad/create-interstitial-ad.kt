...
open class GenPagesAPICreateInterstitialAdCreateInterstitialAd : BasePage {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("errorDetails" to utsArrayOf<String>(), "btnText" to "", "btnType" to "primary", "btnDisable" to false, "interstitialAd" to null as InterstitialAd?, "isAdLoadSuccess" to false)
    }
