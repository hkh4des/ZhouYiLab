            ...
            return fun(): Any? {
                ...
                return createElementVNode("scroll-view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1"))), utsArrayOf(
                    createElementVNode("view", null, utsArrayOf(
                        createVNode(_component_page_head, utsMapOf("title" to "getAccessibilityInfo")),
                        createElementVNode("view", utsMapOf("class" to "uni-common-mt"), utsArrayOf(
                            createElementVNode("text", utsMapOf("style" to normalizeStyle(utsMapOf("margin-left" to "8px"))), "无障碍服务信息如下：", 4),
                            createElementVNode("text", utsMapOf("style" to normalizeStyle(utsMapOf("margin-top" to "15px", "padding" to "8px"))), toDisplayString(unref(accessibilityInfo)), 5)
                        ))
                    ))
                ), 4)
            }
